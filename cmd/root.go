...
var rootCmd = &cobra.Command{
	Use:   "verse",
	Short: "A getting-started go + cobra application",
	Long: `This is a go application that uses cobra to add CLI functionality.

In a cobra style application:
...
func init() {
	...
	// rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.verse.yaml)")
